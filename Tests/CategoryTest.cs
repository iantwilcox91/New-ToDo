...
namespace ToDoList
{
  public class CategoryTest : IDisposable
  {
    ...
    [Fact]
    public void T6_Delete_DeletesCategoryFromDatabase()
    {
      //Arrange
    ...
    [Fact]
   public void T7_AddTask_AddsTaskToCategory()
   {
     //Arrange
     Category testCategory = new Category("Household chores");
     testCategory.Save();
   ...
   [Fact]
    public void T8_GetTasks_ReturnsAllCategoryTasks()
    {
      //Arrange
      Category testCategory = new Category("Household chores");
      testCategory.Save();
    ...
    [Fact]
    public void T9_Delete_DeletesCategoryAssociationsFromDatabase()
    {
      //Arrange
      Task testTask = new Task("Mow the lawn");
      testTask.Save();
